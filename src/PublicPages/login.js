      ...
      <div className="block-1">
        ...
        <div className="block-1__block">
          <form className="block-1__form" onSubmit={handleSubmit}>
            ...
            <a className="block-1__link block-1__link--modify" href="#">
              forgot password?
            </a>
            <button className="block-1__button block-1__input--button ">
              Login
            </button>
          </form>
        </div>
        ...
        <div className="block-1__signup">
          <p className="block-1__desc">
            New to Vroomy?
            <a className="block-1__link" href="/signup">
              {" "}
              Sign up
            </a>
          </p>
